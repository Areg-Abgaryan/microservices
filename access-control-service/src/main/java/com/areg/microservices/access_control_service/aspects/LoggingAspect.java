...
package com.areg.microservices.access_control_service.aspects;
...
public class LoggingAspect {
    ...
    @Pointcut("execution(public * com.areg.controllers.*Controller.*(..)) || " +
            "execution(public * com.areg.services.implementations.*Service.*(..))")
